--- image/decoders/nsJPEGDecoder.cpp.orig	2017-08-10 10:39:31 UTC
...
+
 ...
 namespace mozilla {
@@ -351,6 +366,7 @@ nsJPEGDecoder::ReadJPEGData(const char* aData, size_t 
         case JCS_GRAYSCALE:
         case JCS_RGB:
         case JCS_YCbCr:
+#ifdef JCS_EXTENSIONS
...
@@ -359,6 +375,9 @@ nsJPEGDecoder::ReadJPEGData(const char* aData, size_t 
           } else {
...
+#endif
         ...
         case JCS_CMYK:
         case JCS_YCCK:
@@ -433,6 +452,16 @@ nsJPEGDecoder::ReadJPEGData(const char* aData, size_t 
...
@@ -630,7 +659,11 @@ nsJPEGDecoder::OutputScanlines(bool* suspend)
