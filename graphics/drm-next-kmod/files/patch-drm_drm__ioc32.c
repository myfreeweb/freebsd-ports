--- drm/drm_ioc32.c.orig	2017-09-19 02:47:48 UTC
+++ drm/drm_ioc32.c
@@ -1,4 +1,4 @@
-/**
+/*
...
+	uq32.unique_len = uq.unique_len;
 	if (copy_to_user((void __user *)arg, &uq32, sizeof(uq32)))
 		return -EFAULT;
 	return 0;
@@ -162,30 +165,17 @@ static int compat_drm_getunique(struct file *file, uns
...
@@ -193,32 +183,23 @@ static int compat_drm_getmap(struct file *file, unsign
 {
...
+	m32.mtrr = map.mtrr;
 	if (copy_to_user(argp, &m32, sizeof(m32)))
 		return -EFAULT;
 	return 0;
@@ -230,37 +211,29 @@ static int compat_drm_addmap(struct file *file, unsign
 {
 	drm_map32_t __user *argp = (void __user *)arg;
 	drm_map32_t m32;
-	struct drm_map __user *map;
...
@@ -271,28 +244,22 @@ static int compat_drm_rmmap(struct file *file, unsigne
 			    unsigned long arg)
 {
 	drm_map32_t __user *argp = (void __user *)arg;
-	struct drm_map __user *map;
...
@@ -300,29 +267,24 @@ static int compat_drm_getclient(struct file *file, uns
 {
 	drm_client32_t c32;
...
+	c32.iocs = client.iocs;
 	...
 	if (copy_to_user(argp, &c32, sizeof(c32)))
 		return -EFAULT;
@@ -340,65 +302,53 @@ typedef struct drm_stats32 {
...
+	if (copy_to_user(argp, &desc32, sizeof(drm_buf_desc32_t)))
 	...
 	return 0;
@@ -409,21 +359,17 @@ static int compat_drm_markbufs(struct file *file, unsi
 {
...
@@ -431,54 +377,37 @@ typedef struct drm_buf_info32 {
 	u32 list;
 } drm_buf_info32_t;
...
@@ -495,56 +424,42 @@ typedef struct drm_buf_map32 {
...
@@ -557,21 +472,15 @@ static int compat_drm_freebufs(struct file *file, unsi
 			       unsigned long arg)
 {
...
@@ -583,48 +492,36 @@ static int compat_drm_setsareactx(struct file *file, u
 				  unsigned long arg)
 {
...
+	if (copy_to_user(argp, &req32, sizeof(req32)))
 	...
 	return 0;
@@ -640,26 +537,20 @@ static int compat_drm_resctx(struct file *file, unsign
 {
...
+	if (copy_to_user(argp, &res32, sizeof(res32)))
 	...
 	return 0;
@@ -683,38 +574,26 @@ static int compat_drm_dma(struct file *file, unsigned 
 {
 	drm_dma32_t d32;
...
+	    || put_user(d.granted_count, &argp->granted_count))
 	...
 	return 0;
@@ -729,17 +608,13 @@ static int compat_drm_agp_enable(struct file *file, un
 				 unsigned long arg)
 {
...
@@ -761,28 +636,22 @@ static int compat_drm_agp_info(struct file *file, unsi
 {
...
@@ -801,26 +670,24 @@ static int compat_drm_agp_alloc(struct file *file, uns
 {
...
@@ -831,16 +698,13 @@ static int compat_drm_agp_free(struct file *file, unsi
 			       unsigned long arg)
 {
 	drm_agp_buffer32_t __user *argp = (void __user *)arg;
-	struct drm_agp_buffer __user *request;
...
@@ -853,34 +717,28 @@ static int compat_drm_agp_bind(struct file *file, unsi
 {
...
@@ -893,23 +751,21 @@ static int compat_drm_sg_alloc(struct file *file, unsi
 			       unsigned long arg)
 {
...
+	if (put_user(handle, &argp->handle))
 	...
 	return 0;
@@ -919,19 +775,17 @@ static int compat_drm_sg_free(struct file *file, unsig
 			      unsigned long arg)
 {
 	drm_scatter_gather32_t __user *argp = (void __user *)arg;
-	struct drm_scatter_gather __user *request;
...
+#if defined(CONFIG_X86)
 typedef struct drm_update_draw32 {
 	...
 	unsigned int type;
@@ -944,22 +798,11 @@ static int compat_drm_update_draw(struct file *file, u
 				  unsigned long arg)
 {
...
@@ -986,36 +829,30 @@ static int compat_drm_wait_vblank(struct file *file, u
 {
...
+#if defined(CONFIG_X86)
 typedef struct drm_mode_fb_cmd232 {
 	u32 fb_id;
 	u32 width;
@@ -1032,97 +869,90 @@ static int compat_drm_mode_addfb2(struct file *file, u
 				  unsigned long arg)
 {
...
@@ -1133,14 +963,19 @@ long drm_compat_ioctl(struct file *filp, unsigned int 
