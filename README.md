...
- `x11/libinput`: Update to 1.9.3, remove unnecessary/unused patches [222905](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=222905)
- `devel/libevdev`: Update, fixes uinput [217248](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=217248)
